    ...
    <div class="container text-center">
        ...
        <div class="form-row container mt-5">
            <div class="mt-3 col-md-4 mb-3">
                <a class="adm" title="Usuários" href="crudUsuarios.html"><i class="fas fa-users"></i>
            ...
            <div class="mt-3 col-md-4 mb-3">
                <a class="adm" title="Categorias" href="CrudCategoria.html"><i class="fas fa-list adm"></i>
