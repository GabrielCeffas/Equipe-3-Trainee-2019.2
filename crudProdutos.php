   ...
   <header>
    ...
    <div class="container mt-3">
        <div class="d-flex justify-content-between">
            ...
            <a href="formularioCriarProduto.php"><button type="button" class="btn btn-outline-success">Novo Produto</button></a>
        </div>
        ...
        <a href="homeAdm.html"><button type="button" class="btn btn-outline-dark"><i class="fas fa-arrow-left"></i> Voltar</button></a>
