            ...
            <div class="card-body">
                <form action="<?php echo URL_BASE ."/usuario/salvar" ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="senha" class="form-control" id="inputsenha" placeholder="Digite a senha do usuario">
                    </div>
                    <div class="form-group">
                        <label for="inputurl_imagem">Imagem do usuario</label>
                        <input type="text" name="url_imagem" class="form-control" id="inputurl_imagem" placeholder="imagem do usuario">
                    </div>
                        <div class="col-md-6">
