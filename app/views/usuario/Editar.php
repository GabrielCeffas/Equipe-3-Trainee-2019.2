        ...
        <div class="card-body">
            <form action="<?php echo URL_BASE . "/usuario/salvar" ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="senha" value="<?php echo $usuario->senha ?>" class="form-control" id="inputsenha" placeholder="Digite a senha do usuario">
                </div>
                <div class="form-group">
                    <label for="inputurl_imagem">Imagem do usuario</label>
                    <input type="file" name="url_imagem" value="<?php echo $usuario->url_imagem ?>" class="form-control-file" id="inputurl_imagem">
                </div>
                <div class="col-md-6">
